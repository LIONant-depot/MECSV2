...
#include "E10_share_components2_updating.h"
...
int main(void)
{
    ...
    // Examples
    //
    if(1) mecs::examples::E02_system_introduction::Test();
    if(1) mecs::examples::E03_system_moving_entities::Test();
    if(1) mecs::examples::E04_delegate_moveinout::Test();
    if(1) mecs::examples::E05_custom_delegate_updated_entity::Test();
    if(1) mecs::examples::E06_global_system_events::Test();
    if(1) mecs::examples::E07_double_buffer_components::Test();
    if(1) mecs::examples::E08_quantum_mutable_components::Test();
    if(1) mecs::examples::E09_quantum_double_buffer_components::Test();
    if(1) mecs::examples::E10_shared_components::Test();
    if(1) mecs::examples::E10_shared_components2_updating::Test();
    if(1) mecs::examples::E11_complex_system_queries::Test();
    if(1) mecs::examples::E12_basic_hierarchical_components::Test();
